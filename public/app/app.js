/* ============================================================
   PriceSnap — bibliothèque commune (vanilla JS)
...
const PS = (() => {
  ...
  const DICTS = {
    fr: {
      ...
      home: {
        heroA: "Combien vaut", heroB: "votre objet ?",
        sub: "Prenez une photo, l'IA identifie l'objet, puis l'app cherche de vraies annonces comparables sur le web — en direct — pour vous donner une fourchette de prix honnête.",
        scan: "Scanner un objet", recent: "Estimations récentes", empty: "Aucune estimation — scannez votre premier objet !",
        install: "Installer l'app", potential: "Valeur potentielle", sold: "Déjà revendu",
        features: [
          ["Vision IA", "Identification : marque, modèle, époque, lecture d'étiquettes (OCR)."],
          ["Recherche web en direct", "Annonces comparées en temps réel sur Vinted, eBay, Leboncoin… jamais de prix inventés."],
          ["Fourchette honnête", "Bas / moyen / haut calculés sur les annonces d'occasion réelles, pondérés par l'état."],
          ["Conseils de vente", "Plateformes, mots-clés, photos, période favorable, annonce prête à copier."],
        ],
        offlineNote: "Fonctionne hors-ligne pour consulter vos estimations sauvegardées.",
        privacy: "Confidentialité",
      },
      scan: {
        title: "Scanner un objet", photoHint: "Ajoutez face, dos, étiquette, défauts — plus il y en a, mieux c'est.",
        cam: "Ouvrir la caméra", gal: "Galerie", crop: "Recadrer",
        camErr: "Caméra indisponible ou accès refusé. Utilisez la galerie ou l'appareil photo natif.",
        camNative: "Appareil photo natif", condition: "État de l'objet",
        notes: "Notes (optionnel)", notesPh: "Marque lue sur l'étiquette, défauts, accessoires inclus…",
        barcode: "Code-barres (optionnel)", barcodePh: "ISBN / EAN", lookup: "Rechercher",
        barcodeFound: "Produit trouvé", barcodeNotFound: "Code non reconnu.",
        analyze: "Lancer l'estimation", describe: "Décrire l'objet manuellement",
        ...
        hypTitle: "L'IA hésite — confirmez l'objet", hypHint: "Choisissez la bonne identification pour éviter une estimation fausse, ou corrigez-la.",
        identified: "Objet identifié", manual: "Quel est cet objet ?",
        namePh: "ex : Cafetière Krups Dolce Gusto, iPhone 12…", brand: "Marque", model: "Modèle / réf.",
        lot: "Mode lot", lotHint: "Les estimations s'ajoutent au lot en cours (vide-grenier).",
        addLot: "Ajouter au lot", lotView: "Voir le lot", lotTotal: "Total du lot", lotClear: "Vider", lotCleared: "Lot vidé",
        cropTitle: "Ajuster le cadrage", cropHelp: "Glissez pour recentrer, molette/pincement pour zoomer", confirm: "Valider",
        torch: "Torche", flip: "Retourner", shoot: "Prendre la photo",
        offlineTitle: "Vous êtes hors-ligne", offlineBody: "La recherche de prix en direct nécessite internet. Vos estimations sauvegardées restent consultables.",
      },
      res: {
        range: "Fourchette de prix", low: "Bas", mid: "Moyen", high: "Haut", median: "Médiane web",
        basedOn: "Basé sur", listings: "annonces comparées", usedNote: "Fourchette calculée sur les annonces d'occasion — le neuf est affiché à titre indicatif.",
        dropped: "annonces non pertinentes écartées", usedCount: "annonces d'occasion",
        confidence: "confiance", guided: "Identification guidée",
        comparables: "Annonces comparables trouvées", view: "Voir l'annonce", refresh: "Relancer la recherche web",
        insights: "Analyse du marché", rarity: "Rareté", demand: "Demande", sellTime: "Délai de vente probable", days: "jours",
        verkocht: "Vendu", soldPlatform: "Plateforme (ex : Vinted)",
        anomalies: "Annonces suspectes écartées", noListings: "Aucune annonce comparable récupérée. Affinez le nom ou réessayez.",
        trace: "Traçabilité des recherches", newPrice: "Prix du neuf repéré",
        advice: "Conseils pour vendre", platforms: "Plateformes recommandées", keywords: "Mots-clés pour votre titre",
        photosTip: "Photos à ajouter", period: "Période favorable", copyListing: "Annonce prête à copier",
        copy: "Copier", copied: "Copié !", warnings: "À savoir", markSold: "Marquer comme vendu",
        soldAt: "Vendu", soldPricePh: "Prix de vente réel", save: "Enregistrer", delete: "Supprimer",
      ...
      hist: {
        title: "Historique", subtitle: "Toutes vos estimations sauvegardées", filter: "Filtrer…",
        empty: "Aucune estimation enregistrée.", offlineBadge: "Mode hors-ligne : données en cache",
        potential: "Potentiel total (encore à vendre)", realized: "Total réellement revendu", sold: "Vendu",
      },
      alerts: {
        title: "Alertes prix", subtitle: "Surveillez l'évolution du marché", create: "Créer une alerte",
        queryPh: "ex : cafetière Krups Dolce Gusto", dir: "Notifier si",
        dirs: { any: "le prix bouge", rise: "le prix monte", drop: "le prix baisse" },
        baseline: "Prix de référence", check: "Vérifier maintenant", checking: "Vérification en direct…",
        delete: "Supprimer", empty: "Aucune alerte. Créez-en une ici.",
        changed: "Le marché a bougé", unchanged: "Marché stable", notif: "Activer les notifications",
        denied: "Notifications refusées par le navigateur.", last: "Dernière vérif.", never: "jamais",
      },
      cam: "Caméra", gallery: "Galerie",
      newObject: "Nouvel objet du lot",
      retry: "Réessayer", cached: "Estimations en cache",
    },
    en: {
      appName: "PriceSnap",
      ...
      home: {
        heroA: "How much is", heroB: "your item worth?",
        sub: "Take a photo, AI identifies the item, then the app searches real comparable listings on the web — live — to give you an honest price range.",
        scan: "Scan an item", recent: "Recent estimates", empty: "No estimates yet — scan your first item!",
        install: "Install the app", potential: "Potential value", sold: "Already resold",
        features: [
          ["AI vision", "Identification: brand, model, era, label reading (OCR)."],
          ["Live web search", "Comparable listings fetched in real time from Vinted, eBay, Leboncoin… never made-up prices."],
          ["Honest range", "Low / mid / high computed from real used listings, weighted by condition."],
          ["Selling advice", "Platforms, keywords, photos, favorable period, ready-to-copy listing."],
        ],
        offlineNote: "Works offline to browse your saved estimates.",
        privacy: "Privacy",
      },
      scan: {
        title: "Scan an item", photoHint: "Add front, back, labels, flaws — the more the better.",
        cam: "Open camera", gal: "Gallery", crop: "Crop",
        camErr: "Camera unavailable or access denied. Use the gallery or the native camera app.",
        camNative: "Native camera", condition: "Item condition",
        notes: "Notes (optional)", notesPh: "Brand from the label, flaws, included accessories…",
        barcode: "Barcode (optional)", barcodePh: "ISBN / EAN", lookup: "Look up",
        barcodeFound: "Product found", barcodeNotFound: "Code not recognized.",
        analyze: "Run estimate", describe: "Describe the item manually",
        ...
        hypTitle: "AI is unsure — confirm the item", hypHint: "Pick the right identification to avoid a wrong estimate, or correct it.",
        identified: "Identified item", manual: "What is this item?",
        namePh: "e.g.: Krups Dolce Gusto coffee maker, iPhone 12…", brand: "Brand", model: "Model / ref.",
        lot: "Lot mode", lotHint: "Estimates are added to the current lot (yard sale).",
        addLot: "Add to lot", lotView: "View lot", lotTotal: "Lot total", lotClear: "Clear", lotCleared: "Lot cleared",
        cropTitle: "Adjust framing", cropHelp: "Drag to recenter, slider to zoom", confirm: "Confirm",
        torch: "Torch", flip: "Flip", shoot: "Take the photo",
        offlineTitle: "You are offline", offlineBody: "Live price search needs internet. Saved estimates remain available.",
      },
      res: {
        range: "Price range", low: "Low", mid: "Mid", high: "High", median: "Web median",
        basedOn: "Based on", listings: "comparable listings", usedNote: "Range computed on used listings — new prices shown for reference only.",
        dropped: "irrelevant listings discarded", usedCount: "used listings",
        confidence: "confidence", guided: "Guided identification",
        comparables: "Comparable listings found", view: "View listing", refresh: "Re-run live web search",
        insights: "Market analysis", rarity: "Rarity", demand: "Demand", sellTime: "Likely time to sell", days: "days",
        verkocht: "Sold", soldPlatform: "Platform (e.g.: Vinted)",
        anomalies: "Suspicious listings excluded", noListings: "No comparable listing fetched. Refine the name or retry.",
        trace: "Search traceability", newPrice: "New price spotted",
        advice: "Selling advice", platforms: "Recommended platforms", keywords: "Keywords for your title",
        photosTip: "Photos to add", period: "Best period", copyListing: "Ready-to-copy listing",
        copy: "Copy", copied: "Copied!", warnings: "Good to know", markSold: "Mark as sold",
        soldAt: "Sold", soldPricePh: "Actual sale price", save: "Save", delete: "Delete",
      ...
      hist: {
        title: "History", subtitle: "All your saved estimates", filter: "Filter…",
        empty: "No saved estimate.", offlineBadge: "Offline mode: cached data",
        potential: "Total potential (unsold)", realized: "Total actually resold", sold: "Sold",
      },
      alerts: {
        title: "Price alerts", subtitle: "Monitor the market for an item type", create: "Create alert",
        queryPh: "e.g.: Krups Dolce Gusto coffee maker", dir: "Notify when",
        dirs: { any: "price moves", rise: "price rises", drop: "price drops" },
        baseline: "Reference price", check: "Check now", checking: "Checking live…",
        delete: "Delete", empty: "No alert. Create one here.",
        changed: "Market moved", unchanged: "Market stable", notif: "Enable notifications",
        denied: "Notifications denied by the browser.", last: "Last check", never: "never",
      },
      cam: "Camera", gallery: "Gallery",
      newObject: "New item in lot",
      retry: "Retry", cached: "Cached estimates",
    },
  };
  ...
  function listingRow(l) {
    ...
    src.textContent = l.sourceLabel;
    meta.appendChild(src);
    if (l.conditionText) {
      const c = document.createElement("span");
      c.textContent = `· ${l.conditionText}`;
      meta.appendChild(c);
    }
    if (l.date) {
      const d = document.createElement("span");
    ...
    right.className = "listing-price num";
    right.textContent = fmtPrice(l.price, l.currency);
    ...
    rw.style.textAlign = "right";
    rw.append(right, document.createElement("br"), view);
    a.append(dot, mid, rw);
    return a;
  }
  ...
  const addLot = (id) => { const l = getLot(); if (!l.includes(id)) l.push(id); store.set("ps:lot", l); return l; };
  const removeLot = (id) => { const l = getLot().filter((x) => x !== id); store.set("ps:lot", l); return l; };
  ...
  async function cropImage(src, { zoom, offsetX, offsetY, outSize = 900 }) {
    ...
    ctx.fillStyle = "#000"; ctx.fillRect(0, 0, outSize, outSize);
  ...
  function chrome(active, { back } = {}) {
    ...
    if (back) {
      ...
      logo.innerHTML = `<span class="logo-badge">${ICONS.scan}</span><span>Price<span class="accent">Snap</span></span>`;
  ...
  return {
    t, get lang() { return LANG; }, setLang, ICONS, icon: I, sourceDot,
    fmtPrice, timeAgo, spinnerHTML, toast, listingRow, isNewListing,
    cacheHistory, readHistory, cacheEst, readEst, getLot, addLot, removeLot, clearLot,
    compressImage, cropImage, registerPWA, install, isOnline, chrome, copyText,
    CONDITIONS,
  };
})();
